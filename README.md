...
> **Try it:** sign in with a one-click demo account on the [live site](https://chokepoint.vercel.app) — no signup. A recruiter can be inside the console in 30 seconds. (Deploy is one command — see below.)
